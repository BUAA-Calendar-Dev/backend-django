...
class Activity(models.Model):
    ...
    content = models.TextField(default="活动描述", verbose_name="content")
    ...
    comments = models.ManyToManyField(Comment, verbose_name="activity_comment", related_name="comment_activities", blank=True)
